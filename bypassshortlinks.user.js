...
'use strict';
  ...
  BypassedByBloggerPemula(/ctv23.pro/,()=>{let hashIndex=window.location.href.indexOf('#');if(hashIndex!==-1){let Decipher=atob(atob(atob(window.location.href.substr(hashIndex+1)))),dbq=Decipher.split('|')[0];redirect(dbq,!1)}});
